...
export default function SectionHeading({
  ...
  return (
    <div className={`w-full mb-12 md:mb-16 ${align === 'center' ? 'text-center' : ''}`}>
      {/* Top Metadata / Tag */}
      <motion.div
      ...
      <motion.h2
        ...
        } text-4xl sm:text-5xl md:text-7xl lg:text-8xl leading-[0.92]`}
      >
        {title}
      </motion.h2>
      ...
      {subtitle && (
        <motion.p
          ...
          className={`mt-4 text-base md:text-xl font-normal max-w-2xl ${

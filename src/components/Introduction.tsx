...
export default function Introduction() {
  return (
    <section id="about" className="py-20 sm:py-24 md:py-36 bg-[#F8F5EE] border-b border-black/10 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-12">
        {/* Section Tag */}
        <div className="flex items-center justify-between mb-10 sm:mb-16 border-b border-black/10 pb-3 sm:pb-4 font-mono text-[10px] sm:text-xs uppercase tracking-widest text-[#87827B]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 font-display font-extrabold uppercase text-[#121110] leading-[0.94] text-[2.25rem] xs:text-4xl sm:text-6xl md:text-7xl lg:text-[4.75rem] tracking-tight flex flex-col gap-1 sm:gap-2 max-w-full">
            <div>
          ...
          <div className="lg:col-span-5 flex flex-col justify-between h-full pt-2">
            <motion.div
              ...
              className="space-y-4 sm:space-y-6 text-base sm:text-xl md:text-2xl text-[#57534E] leading-relaxed font-normal"
            >
              <p>
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4 pt-8 sm:pt-14">
              {[
                {

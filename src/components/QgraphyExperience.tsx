...
import { Briefcase, Layers, Code, Palette, Share2, Sparkles, Plus, Image as ImageIcon } from 'lucide-react';
...
export default function QgraphyExperience() {
  return (
    <section id="experience" className="py-24 md:py-36 bg-[#121110] text-[#F8F5EE] border-b border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12 relative z-10">
        ...
        <motion.div
          ...
          className="p-8 sm:p-12 md:p-16 rounded-3xl bg-white/[0.03] border border-white/15 relative overflow-hidden mb-16"
        >
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 pb-8 border-b border-white/10">
            <div>
              ...
              <h3 className="font-display font-black text-3xl sm:text-5xl md:text-6xl uppercase tracking-tight text-white">
                DESIGN & DIGITAL PRODUCT INTERN
              </h3>
              <p className="font-mono text-sm text-[var(--accent-light)] mt-2">
                NOV 2025 — PRESENT · Q-GRAPHY
              </p>
            </div>

            <div className="text-left lg:text-right font-mono text-xs text-[#A8A29E] space-y-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {CAPABILITY_PILLARS.map((item, idx) => (
                <motion.div
                  ...
                  className="p-5 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-[var(--accent)]/40 transition-colors"
                >
                  <div className="flex items-center gap-3 mb-2">
                    <span className="p-2 rounded-lg bg-white/5">{item.icon}</span>
                    <span className="font-display font-bold text-base uppercase text-white tracking-wide">
                      {item.title}
                    </span>
                  </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6">
            <h4 className="font-display font-extrabold text-2xl sm:text-3xl uppercase tracking-tight text-white mb-2">
              MILESTONES & GROWTH
            </h4>
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            {/* Artifact Card 01 */}
            <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all group">
              <div className="aspect-[16/9] rounded-xl bg-gradient-to-br from-[#1F1C18] to-[#121110] border border-white/10 p-6 flex flex-col justify-between relative overflow-hidden">
                <div className="flex justify-between items-center text-[10px] font-mono text-white/50">
                  <span className="px-2 py-0.5 rounded bg-black/40 border border-white/10">UI/UX & DESIGN SYSTEMS</span>
                  <span>Q-GRAPHY ASSET #01</span>
                </div>
                <div className="text-center my-auto">
                  <ImageIcon className="w-8 h-8 text-[var(--accent)] mx-auto mb-2 opacity-80" />
                  <p className="font-display font-bold text-lg text-white uppercase">Product Interfaces & Visual Components</p>
                  <p className="font-mono text-xs text-white/50 mt-1">Design System Guidelines & Screen Layouts</p>
                </div>
            ...
            {/* Artifact Card 02 */}
            <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all group">
              <div className="aspect-[16/9] rounded-xl bg-gradient-to-br from-[#161B1E] to-[#0E1114] border border-white/10 p-6 flex flex-col justify-between relative overflow-hidden">
                <div className="flex justify-between items-center text-[10px] font-mono text-white/50">
                  <span className="px-2 py-0.5 rounded bg-black/40 border border-white/10">AI WORKFLOWS & PROMPTS</span>
                  <span>Q-GRAPHY ASSET #02</span>
                </div>
                <div className="text-center my-auto">
                  <Sparkles className="w-8 h-8 text-sky-400 mx-auto mb-2 opacity-80" />
                  <p className="font-display font-bold text-lg text-white uppercase">Structured Generative Systems</p>
                  <p className="font-mono text-xs text-white/50 mt-1">Prompt Blueprints & Multi-Modal Automation</p>
                </div>

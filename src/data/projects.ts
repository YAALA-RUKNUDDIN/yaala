...
export const PROJECTS_DATA: Project[] = [
  ...
  },
  {
    ...
    tagline: 'Official logo & visual identity for AITM CSE (AIML & Data Science Forum).',
    description:
      'Designed the official logomark and visual identity system for NOVA — the student forum of AITM under the Department of Computer Science & Engineering for AIML & Data Science. Crafted with isometric precision geometry, orbital data nodes, and electric neural gradients representing intelligence beyond limits.',
    deliverables: ['Logo Design', 'Geometric Grid System', 'Visual Identity Specs', 'AIML & Data Science Branding', 'Vector Assets'],
    type: 'professional',
    bgGradient: 'from-[#141026] via-[#1E1738] to-[#0D0B18]',
    accentColor: '#6366F1',
    featured: true,
    image: '/images/nova/nova-grid.png',
    imageGrid: '/images/nova/nova-mark.png',
  },
  {
  ...
  },
  {
    ...
    accentColor: '#7ECEB2',
    featured: false,
    github: 'https://github.com/YAALA-RUKNUDDIN/yaala',
  },
];
...
export const SOCIAL_LINKS = {
  ...
  github: 'https://github.com/YAALA-RUKNUDDIN',
};
